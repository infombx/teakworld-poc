...
import { placeOrder } from '@/lib/strapi/placeOrder';
...
export default function CartPage() {
    ...
    const handlePlaceOrder = async (formData: any) => {
        ...
        try {
            await placeOrder(formData, items);
                                            ...
                                            {items.map((item) => (
                                                <div key={item.cartId} className="flex gap-4">
                                                    <div className="relative w-16 h-16 flex-shrink-0">
                                                        ...
                                                        <span className="absolute -top-2 -right-2 w-5 h-5 rounded-full bg-gray-500 text-white text-xs font-bold flex items-center justify-center z-10">
                                                            {item.quantity}
                                                        </span>
                                                    </div>
